...
> **Railway Deploy – IMPORTANT:** This is a monorepo. In Railway you MUST set a Root Directory per service:
> - **API Service → Root Directory = `backend`**
> - **Dashboard Service → Root Directory = `dashboard`**
> If you build from the repo root you'll get `Railpack could not determine how to build` – that's expected, set the Root Directory.
